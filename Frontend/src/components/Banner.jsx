...
const Banner = () => {
    ...
    return (
        <div className='flex bg-gray-900 rounded-lg  px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
            ...
            <div className='hidden md:block md:w-1/2 lg:w-[370px] relative'>
                <img className='w-full absolute bottom-0 right-0 max-w-md' src={assets.CookB} alt="" />
            </div>
        </div>
    )
}
