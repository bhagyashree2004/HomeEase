...
const ProfessionalProfile = () => {
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/professionals/update-profile', updateData, { headers: { dToken } })
            ...
            <div className='flex flex-col gap-4 m-5'>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    <p className='text-gray-600 font-medium mt-4'>
                        Service Charges: <span className='text-gray-800'>{currency} {isEdit ? <input type='number' onChange={(e) => setProfileData(prev => ({ ...prev, rates: e.target.value }))} value={profileData.rates} /> : profileData.rates}</span>
                    </p>
